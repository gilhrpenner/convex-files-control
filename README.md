...
# Convex Convex Files Control

[![npm version](https://badge.fury.io/js/@example%2Fconvex-files-control.svg)](https://badge.fury.io/js/@example%2Fconvex-files-control)
...
[File it here](https://github.com/gilhrpenner/convex-files-control/issues).
...
export const addComment = mutation({
  ...
  handler: async (ctx, args) => {
    return await ctx.runMutation(components.convexFilesControl.lib.add, {
      text: args.text,
